...
export default function Sidebar({ userName }: { userName?: string }) {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-60 min-h-screen border-r border-white/[0.06] bg-white/[0.02] px-3 py-6">
      {/* Logo */}
      <div className="flex items-center gap-3 px-3 mb-8">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-purple-600 to-violet-700 flex items-center justify-center shadow-lg flex-shrink-0">
